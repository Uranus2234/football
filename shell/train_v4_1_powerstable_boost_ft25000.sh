...
python scripts/rsl_rl/train_student.py \
  ...
  --load_checkpoint_path "${CHECKPOINT_PATH:-checkpoints/v4_1_sidefoot_stable_model_25000.pt}" \
  --run_name "${RUN_NAME:-nearfield_goalkick_v4_1_powerstable_boost_ft25000_4096}" \
